...
const levels = [
  ...
  },
  {
    ...
    description: 'Master 15 Hukum Kepemimpinan Maxwell — diterapkan langsung ke bisnis & keluarga. Hasil terukur dalam 30 hari.',
    items: [
      { icon: Target, text: 'Hukum Proses & Hukum Prioritas — Fokus pada pertumbuhan bertahap' },
      { icon: Users, text: 'Hukum Tim & Hukum Pemberdayaan — Bangun tim yang mandiri' },
      { icon: BookOpen, text: 'Hukum Pantulan & Hukum Warisan — Dampak yang melampaui dirimu' },
      { icon: TrendingUp, text: 'Hukum Pertumbuhan & Hukum Navigasi — Rencana jelas, eksekusi konsisten' },
    ],
    cta: 'Info Program',
  ...
  },
  {
    ...
    title: 'Business & Leadership (Atomy)',
    description: 'Dengan fondasi growth & leadership, Atomy jadi vehicle income opsional jangka panjang — konsumsi sendiri dulu, sharing kalau cocok.',
    items: [
      { icon: Zap, text: 'Sistem Atomy & Duplikasi Tim — Tanpa beli grosir wajib' },
      { icon: Crown, text: 'Passive Income & Legacy Building — Konsumsi sendiri + sharing organik' },
      { icon: TrendingUp2, text: 'Kesejahteraan Jangka Panjang — Produk konsumsi harian real' },
      { icon: Repeat, text: 'Sistem Berkelanjutan — Produk yang ibu beli rutin' },
    ],
