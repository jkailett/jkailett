...
export default function ChallengeForm() {
  ...
  return React.createElement('form', { onSubmit: handleSubmit(onSubmit), className: 'space-y-5', noValidate: true },
    React.createElement('div', { className: 'space-y-5' },
      React.createElement('div', null,
        ...
        React.createElement('input', Object.assign({}, register('name'), { id: 'name', type: 'text', placeholder: 'Contoh: Bunda Sari', className: 'w-full px-4 py-4 rounded-xl border-2 border-warm-sand/60 bg-white/70 backdrop-blur-sm text-soft-black placeholder:text-soft-black/30 focus:outline-none focus:border-sage-green/50 focus:ring-2 focus:ring-sage-green/20 transition-all duration-300' + (errors.name ? ' border-terracotta' : ''), 'aria-invalid': errors.name ? 'true' : 'false' })),
      ...
      React.createElement('div', null,
        ...
        React.createElement('div', { className: 'relative' },
          ...
          React.createElement('input', Object.assign({}, register('phone'), { id: 'phone', type: 'tel', placeholder: '8xx-xxxx-xxxx', className: 'w-full pl-12 pr-4 py-4 rounded-xl border-2 border-warm-sand/60 bg-white/70 backdrop-blur-sm text-soft-black placeholder:text-soft-black/30 focus:outline-none focus:border-sage-green/50 focus:ring-2 focus:ring-sage-green/20 transition-all duration-300' + (errors.phone ? ' border-terracotta' : ''), 'aria-invalid': errors.phone ? 'true' : 'false' }))
        ),
