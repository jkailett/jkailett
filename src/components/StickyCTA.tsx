    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 px-4 pb-4 sm:pb-6 md:pb-8">
      <div className="max-w-xl mx-auto">
        <a
          ...
          className="w-full btn-primary py-4 text-center group shadow-terracotta-lg inline-flex items-center justify-center"
          aria-label="Gabung 7 Hari Gratis via WhatsApp"
        >
